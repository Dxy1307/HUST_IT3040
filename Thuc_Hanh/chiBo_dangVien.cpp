...
void nhapDangVien(DV &dv) {
    ...
    // cout << "\tNam vao Dang: "; cin >> dv.namVaoDang;
    cout << endl;
    cout << "\tNgay vao dang: \n";
...
void nhapChiBo(CB &cb) {
    ...
    // cout << "Dia chi: "; fflush(stdin); gets(cb.diaChi);
    cout << endl;
...
void inDanhSachChiBo(CB chibos[], int n) {
    ...
    for(int i = 0; i < n; i++) {
        ...
        for(int j = 0; j < chibos[i].soDangVien; j++) {
            // printf("\n %d", chibos[i].dangViens[j].soTheDV);
            // printf("\t %s", chibos[i].dangViens[j].tenDangVien);
            // printf("\t\t %d-%d-%d", chibos[i].dangViens[j].ngay, chibos[i].dangViens[j].thang, chibos[i].dangViens[j].nam);
            // printf("\t %d", 2022 - chibos[i].dangViens[j].nam);
            // printf("\t %s", chibos[i].dangViens[j].chucVuDang);
            // printf("\t    %.3f", chibos[i].dangViens[j].tienPhuCap);
            // printf("\t %.0f", chibos[i].dangViens[j].luong);
            // printf("\t %.2f", chibos[i].dangViens[j].dangPhi);
            // cout << endl;
